...
const RegisterCompanyAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await axios.post('https://localhost:5000/api/register/company-admin', {
      firstName: firstName,
      lastName: lastName,
      companyName: company,
      email: email,
  ...
  return (
    <section className='container mt-5'>
      ...
      <form className='w-50 mx-auto mt-5' onSubmit={handleSubmit}>
        ...
        <input type="text" name="company" id="company" onChange={(e) => { setCompany(e.target.value) }} value={company} className='form-control' placeholder='الشركة...' required />
